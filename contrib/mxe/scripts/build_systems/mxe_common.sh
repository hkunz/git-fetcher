...
HOST_TOOLS=(python python3 pybind11 pythonlibsnew module cmake meson ninja pkgconf pkg-config doxygen sphinx git perl pythoninterp wxwidgets jni java nuke apputils imageioapphelpers ocioarchive ociobakelut ociocheck ociochecklut ocioconvert ociolutimage ociomakeclf ociomergeconfigs ocioperf ociowrite ofxplugin oglapphelpers)
